...
\textbf{CAT-01.} Une catégorie est constituée d'objets, de morphismes munis d'une
...
\textbf{CAT-02.} Un foncteur $ F\colon \mathcal{C} \to \mathcal{D} $
...
\textbf{CAT-03.} Un \textit{produit} des objets $ A $ et $ B $ est un
...
\textbf{CAT-04.} Un objet est \textit{initial} s'il existe exactement un
...
\textbf{CAT-05.} Une \textit{transformation naturelle} $ \eta $ entre
...
\textbf{CAT-06.} Les catégories $ \mathcal{C} $ et $ \mathcal{D} $ sont
...
\textbf{CAT-16.} Un \textit{égaliseur} de $ f, g\colon A \to B $ est un morphisme
...
\textbf{CAT-17.} Pour un ensemble $ B $, soit $ \mathbf{Set}/B $ la catégorie
...
\textbf{CAT-18.} Étant donné des foncteurs $ F\colon \mathcal{A} \to \mathcal{C} $ et
...
\textbf{CAT-26.} Soient $ (P, \le) $ et $ (Q, \le) $ des ensembles ordonnés, chacun vu
...
\textbf{CAT-27.} Pour un endofoncteur $ F \colon \mathcal{C} \to \mathcal{C} $, une
...
\textbf{CAT-07.} Un foncteur $ F\colon \mathcal{C} \to \mathbf{Set} $ est
...
\textbf{CAT-08.} Soit $ \mathcal{C} $ une catégorie localement petite.
\begin{enumerate}
...
\textbf{CAT-09.} Des foncteurs $ F\colon \mathcal{C} \to \mathcal{D} $ et
...
\textbf{CAT-10.} Une \textit{limite} d'un diagramme $ D\colon \mathcal{J} \to
...
\textbf{CAT-11.} Une \textit{monade} sur $ \mathcal{C} $ est un foncteur
...
\textbf{CAT-12.} Une catégorie à produits finis est \textit{cartésienne
...
\textbf{CAT-19.} Soit $ \mathcal{C} $ petite et soit $ \mathcal{D} $
...
\textbf{CAT-20.} Soit $ \mathcal{C} $ une petite catégorie, soit
...
\textbf{CAT-21.} D'après CAT-10, un foncteur admettant un adjoint à gauche préserve les
...
adjoint à gauche --- la compactification de Stone--\v{C}ech.
\end{enumerate}
...
La partie (d) explique pourquoi Stone--\v{C}ech est un adjoint à gauche et préserve donc les coproduits
...
\item Contexte : Compactification de Stone--\v{C}ech --- Wikipédia (\url{https://fr.wikipedia.org/wiki/Compactification_de_Stone-%C4%8Cech})
...
\textbf{CAT-22.} Une \textit{catégorie monoïdale} est une catégorie $ \mathcal{V} $ munie d'un
...
\textbf{CAT-29.} Soient $ K \colon \mathcal{A} \to \mathcal{B} $ et
...
\textbf{CAT-30.} Soit $ (T, \eta, \mu) $ une monade sur $ \mathcal{C} $ (CAT-11). Une
...
\textbf{CAT-31.} Un \textit{topos élémentaire} est une catégorie possédant les limites finies, les
...
\textbf{CAT-32.} Le \textit{nerf} d'une petite catégorie $ \mathcal{C} $
...
\textbf{CAT-33.} Pour des foncteurs $ F, G \colon \mathcal{C} \to \mathcal{D} $
...
\textbf{CAT-13.} La théorie classique (\og{} analytique \fg{}) des $\infty$-catégories, telle que développée
...
\textbf{CAT-14.} En théorie homotopique des types (HoTT) --- le fondement dans lequel les types
...
\textbf{CAT-15.} L'axiome d'univalence de Voevodsky affirme que pour des types
...
\textbf{CAT-23.} Dans \textit{Pursuing Stacks} (1983), Grothendieck a donné une
...
\textbf{CAT-24.} Gordon, Power et Street ont démontré en 1995 que toute
...
\textbf{CAT-25.} Une théorie topologique des champs de dimension $ n $ est un foncteur
...
\textbf{CAT-34.} Une \textit{catégorie triangulée} est une catégorie additive munie d'un
...
\textbf{CAT-35.} Le principe de Vop\v{e}nka --- l'axiome de grand cardinal
...
d'orthogonalité et principe de Vop\v{e}nka se révèlent être presque le même énoncé, de sorte qu'une
...
n'est donc pas démontrable dans ZFC ; la force exacte de la forme faible du principe de Vop\v{e}nka
fait l'objet de travaux continus. Casacuberta, Scevenels et Smith ont porté le lien en théorie de
l'homotopie en 2005, en montrant que sous le principe de Vop\v{e}nka tout foncteur homotopiquement
...
\begin{refs}
\item Contexte : Principe de Vop\v{e}nka --- Wikipédia (en anglais) (\url{https://en.wikipedia.org/wiki/Vop%C4%9Bnka%27s_principle})
