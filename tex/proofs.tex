...
\textbf{PRF-12.} Tout entier $ n \ge 2 $ peut s'écrire comme un produit de nombres
premiers.
\begin{enumerate}
...
\textbf{PRF-13.} Le principe extrémal : pour démontrer qu'il existe un objet possédant
...
\textbf{PRF-14.} Le théorème d'Euclide --- et l'art de ne pas le citer de travers.
\begin{enumerate}
...
\textbf{PRF-15.} Considérez la série $ \sum_{n=1}^{\infty} \frac{1}{n^2} $ ---
...
\textbf{PRF-16.} L'argument original d'Euler, en 1734, traitait
...
\textbf{PRF-17.} Deux routes pleinement rigoureuses vers la somme de Bâle. Choisissez-en
...
\textbf{PRF-18.} Soit p un nombre premier. Démontrez que
...
\textbf{PRF-19.} Le test de primalité de Fermat : pour tester n, choisissez une base a
...
\textbf{PRF-20.} Une caractérisation exacte de la primalité --- et l'écart entre un
...
\textbf{PRF-21.} La méthode diagonale de Cantor, parcourue du concret à
l'abstrait.
\begin{enumerate}
...
et nommez l'autoréférence qui en est le c\oe{}ur.
\end{enumerate}
...
\textbf{PRF-22.} Soit $ e = \sum_{n=0}^{\infty} \frac{1}{n!} $.
\begin{enumerate}
...
\textbf{PRF-23.} Démontrez l'inégalité entre moyenne arithmétique et moyenne
...
\textbf{PRF-24.} Démontrez que, pour tous réels
...
\textbf{PRF-25.} La formule d'Euler pour les polyèdres, et le contre-exemple qui met à
...
\textbf{PRF-26.} Un théorème de géométrie réelle, et la configuration complexe qui
...
a dormi cinquante ans, jusqu'à ce qu'Erd\H{o}s la réveille en 1943, et Gallai l'a démontrée en
...
technique de PRF-13) qu'Erd\H{o}s avait rangé dans son \og{} Livre \fg{} imaginaire des démonstrations
...
\textbf{PRF-27.} La démonstration suivante de l'énoncé (vrai)
...
polies, si bien que le métier du polissage n'est jamais vu à l'\oe{}uvre. L'essai de Halmos de
...
\textbf{PRF-41.} Le principe du bon ordre (PBO) dit : toute partie non vide d'entiers
...
\textbf{PRF-42.} Une démonstration par contre-exemple minimal s'ouvre ainsi :
...
\textbf{PRF-43.} Pour tuer un énoncé universel, un seul objet bien fait suffit. Pour
...
\textbf{PRF-44.} Écrivez la négation exacte de \og{} pour tout
...
\textbf{PRF-45.} Démontrez qu'il existe des nombres irrationnels a et
...
\textbf{PRF-47.} Soit p un nombre premier tel que $ p \equiv 1 \pmod 4 $ et soit
...
\textbf{PRF-56.} Un raisonnement par l'absurde suppose P fausse, en tire une absurdité,
...
\textbf{PRF-57.} Définissez un arbre binaire comme étant soit une
...
que tout arbre binaire a exactement une feuille de plus qu'il n'a de n\oe{}uds internes, et que
...
\textbf{PRF-58.} Dites que deux polygones sont \textit{équidécomposables} si l'un peut
...
\item[(b)] Route 2 : donnez la démonstration élémentaire par dénombrement d'Erd\H{o}s (1938), qui n'a
...
La démonstration alternative d'Erd\H{o}s est la première entrée de \textit{Proofs from THE
BOOK}.
...
\textbf{PRF-29.} Sur les entiers $\mathbb{Z}$, dites qu'un ensemble est ouvert s'il est une
...
\textbf{PRF-30.} Le théorème de Schröder--Bernstein : s'il existe des injections
...
\textbf{PRF-31.} L'arme propre de Fermat : la \textit{descente infinie}.
\begin{enumerate}
...
\textbf{PRF-32.} Prenez un théorème de cette page que vous avez déjà démontré ---
...
\textbf{PRF-48.} Soit $ R(k,k) $ le plus petit n tel que toute coloration en rouge et
...
alors $ R(k,k) >n $, et déduisez-en la borne d'Erd\H{o}s $ R(k,k) >2^{k/2} $ pour
$ k \ge 3 $.
...
\item[(c)] Énoncez précisément le lemme local de Lovász (Erd\H{o}s--Lovász, 1975), y compris
...
\noindent La note d'Erd\H{o}s de 1947 sur les nombres de Ramsey fait trois pages, et
...
des tournois à nombreux chemins hamiltoniens, mais c'est Erd\H{o}s qui en a fait une méthode, et
...
\item Article : P. Erd\H{o}s, \og{} Some remarks on the theory of graphs \fg{} (1947), \textit{Bulletin of the AMS} 53
...
\textbf{PRF-49.} Démontrez le théorème d'Euler selon lequel le nombre
...
même tension est à l'\oe{}uvre dans l'involution de PRF-47.
...
\begin{problem}[{Le squelette de la démonstration de Bertrand par Erd\H{o}s --- Master, short}]
\textbf{PRF-50.} Lisez la démonstration par Erd\H{o}s du postulat de
...
Ramanujan en a donné une démonstration plus courte en 1919 ; et en 1932 Erd\H{o}s, âgé de
...
\item Article : P. Erd\H{o}s, \og{} Beweis eines Satzes von Tschebyschef \fg{} (1932), \textit{Acta Litterarum ac Scientiarum (Szeged)} 5, 194--198
...
\textbf{PRF-59.} Quelque part dans la plupart des arguments ci-dessous, une sélection
...
\textbf{PRF-60.} Le Nullstellensatz combinatoire d'Alon. Soit F un corps et soit
...
trouvé.
\item[(c)] Déduisez-en le théorème d'Erd\H{o}s--Ginzburg--Ziv : parmi $ 2n - 1 $ entiers quelconques,
...
\textbf{PRF-61.} Démontrez le cas ensembliste du théorème du point fixe
...
\textbf{PRF-33.} Euler ne s'est pas arrêté à $ \zeta(2) $ : il a démontré
...
\textbf{PRF-34.} Le théorème de Wilson (PRF-20) dit que p divise
...
\textbf{PRF-35.} Un système de démonstration propositionnel est, informellement, tout
...
\textbf{PRF-36.} Sylvester--Gallai (PRF-26) garantit une droite ordinaire ; combien
...
\textbf{PRF-51.} Plusieurs théorèmes reposent désormais sur des démonstrations
...
\textbf{PRF-52.} Erd\H{o}s--Szekeres (1935) donne
...
Erd\H{o}s avait notoirement offert des prix distincts pour les deux moitiés de la question. Lisez
...
constante de l'estimation d'Erd\H{o}s de 1947 ayant été améliorée pour la première fois.
...
\textbf{PRF-53.} La conjecture de Frankl (1979) affirme que dans toute
...
\textbf{PRF-62.} Lire la recherche est un savoir-faire que personne n'enseigne et que
tout le monde est censé posséder. Choisissez un article dans cette liste --- tous courts, tous
réels, tous cités ailleurs sur cette page : Erd\H{o}s, \og{} Some remarks on the theory of graphs \fg{}
...
\textbf{PRF-63.} L'arithmétique des fonctions élémentaires (EFA) est le
