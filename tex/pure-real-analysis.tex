...
\textbf{RA-04.} Une fonction $ f $ est continue en un point $ c $ si
...
\textbf{RA-06.} Une suite $ (a_n) $ est \textit{de Cauchy} si pour tout
...
\textbf{RA-08.} Démontrez le théorème des valeurs intermédiaires : si $ f $ est
...
\textbf{RA-09.} Démontrez le théorème des bornes atteintes : une fonction
...
\textbf{RA-10.} Une suite de fonctions $ f_n $ converge
...
\textbf{RA-11.} (Problème de compréhension.) La fonction de Weierstrass est
...
\textbf{RA-12.} Soit $ C $ l'ensemble triadique de Cantor : de
...
\textbf{RA-13.} Un ensemble est \textit{d'intérieur vide} (rare) si son adhérence ne contient
...
\textbf{RA-27.} Soit $ K $ un espace métrique compact et soient
...
\textbf{RA-28.} Dites que $ f : (a,b) \to \mathbb{R} $ est \textit{convexe} si
...
\textbf{RA-29.} Pour $ f : [a,b] \to \mathbb{R} $, la \textit{variation totale} est
...
\textbf{RA-38.} Soit $ C \subset [0,1] $ l'ensemble triadique de Cantor de RA-12. Définissez
...
\textbf{RA-39.} Démontrez le théorème de Darboux : si $ f $ est dérivable
...
\textbf{RA-15.} Définissez la mesure extérieure de $ E \subset \mathbb{R} $ par
...
\begin{problem}[{Les théorèmes de convergence à l'\oe{}uvre --- Master}]
\textbf{RA-16.} \begin{enumerate}
...
\textbf{RA-19.} (Problème de compréhension.) Le paradoxe de Banach--Tarski : une
...
\textbf{RA-20.} Démontrez le théorème de différentiation de Lebesgue : si $ f $ est
...
\textbf{RA-30.} Soit $ K $ un espace compact séparé et soit
...
\textbf{RA-31.} Soit $ (X, \mathcal{M}, \mu) $ un espace mesuré avec
...
\textbf{RA-32.} Soit $ K $ un espace métrique compact. Une famille $ \mathcal{F} $ de
...
\textbf{RA-40.} Dites que $ f : [a,b] \to \mathbb{R} $ est \textit{absolument continue} si pour
...
\textbf{RA-41.} Démontrez le théorème de Lusin : si $ f $ est mesurable et
...
\textbf{RA-42.} Munissez $ C[0,1] $ de la norme de la borne supérieure et soit $ L $ une
...
\textbf{RA-43.} Soit $ E \subseteq \mathbb{R} $ Lebesgue-mesurable avec
...
\textbf{RA-21.} Un \textit{ensemble de Kakeya} (ensemble de Besicovitch) dans
...
\textbf{RA-22.} La transformée de Fourier d'une fonction $ L^1 $ est
...
\textbf{RA-23.} Pour un ensemble $ E \subset \mathbb{R}^n $, son ensemble
...
distances deux à deux distinctes (problème d'Erd\H{o}s de 1946, essentiellement résolu par Guth et Katz
en 2015).
\end{problem}

\noindent Kenneth Falconer a posé la conjecture en 1985 comme analogue continu du problème
des distances distinctes d'Erd\H{o}s. \textbf{Statut : ouvert en toute dimension.} Le meilleur seuil connu
...
\textbf{RA-33.} Dites qu'un ensemble mesurable borné
...
\textbf{RA-34.} Pour $ \delta > 0 $, l'opérateur de Bochner--Riesz sur
...
\begin{problem}[{Le problème de similarité d'Erd\H{o}s --- Recherche}]
\textbf{RA-35.} Dites qu'un ensemble $ A \subseteq \mathbb{R} $ est \textit{universel} si tout
...
$ t \ne 0 $. Erd\H{o}s a demandé vers 1974 si un ensemble infini quelconque peut être universel, et a
...
\noindent Le problème est un spécimen parfait du goût d'Erd\H{o}s : un étudiant de première
...
\begin{refs}
\item Contexte : Théorème de densité de Lebesgue --- Wikipédia (en anglais) (\url{https://en.wikipedia.org/wiki/Lebesgue%27s_density_theorem})
\item Article : K. J. Falconer, \og{} On a problem of Erd\H{o}s on sequences and measurable sets \fg{} (1984), Proc. Amer. Math. Soc. 90, 77--78
\item Article : Y. Jung, C.-K. Lai \& Y. Mooroogen, \og{} Fifty years of the Erd\H{o}s similarity conjecture \fg{} (2024), arXiv:2412.11062 (\url{https://arxiv.org/abs/2412.11062})
\end{refs}

\bigskip

\begin{problem}[{Le problème des ensembles de Furstenberg --- Recherche}]
\textbf{RA-44.} Fixez $ 0 < s \le 1 $ et $ 0 < t \le 2 $. Un ensemble
...
\textbf{RA-45.} Si $ F : [0,1] \to \mathbb{R} $ est dérivable en tout
