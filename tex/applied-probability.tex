...
\item[(c)] Sommez : déduisez-en le théorème de Moivre-Laplace
$ P\big( a \le \frac{S_n - n/2}{\sqrt{n}/2} \le b \big) \to
\frac{1}{\sqrt{2\pi}}\int_a^b e^{-x^2/2}\,dx $.
\item[(d)] Énoncez soigneusement --- sans démonstration ---
...
\item[(c)] Montrez que l'infinité est essentielle : exhibez une famille échangeable finie --- par exemple
