...
\item[(c)] En déduire que, pour $A$ inversible, l'inverse $A^{-1}$ est un polynôme en $A$ de degré au
plus $n - 1$.
\item[(d)] Le théorème vaut-il sur un anneau commutatif quelconque ? Démontrer ou
réfuter.
\end{enumerate}
