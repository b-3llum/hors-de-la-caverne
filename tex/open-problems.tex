...
\textbf{OPEN-01.} La fonction zêta de Riemann est définie pour
...
\textbf{OPEN-02.} $ \mathrm{P} $ est la classe des problèmes de
...
\textbf{OPEN-03.} Pour un écoulement incompressible dans
...
\textbf{OPEN-04.} \textbf{Démontrez que, pour tout groupe de jauge simple
...
\textbf{OPEN-05.} Soit $ X $ une variété projective complexe non
...
\textbf{OPEN-06.} Soit $ E $ une courbe elliptique sur
...
\textbf{OPEN-44.} Énoncez la différence entre $ \mathrm{P} $,
...
\textbf{OPEN-45.} Montrez que si le couple $ (u, p) $ est solution
...
\textbf{OPEN-08.} Soit $ s > 1 $ un réel.
\begin{enumerate}
...
\textbf{OPEN-10.} Rappelons qu'une formule sous forme normale conjonctive est une
...
\textbf{OPEN-11.} Une machine à oracle peut interroger l'appartenance à un ensemble fixé
...
\textbf{OPEN-12.} Considérez les équations de Navier--Stokes d'OPEN-03.
\begin{enumerate}
...
\textbf{OPEN-13.} Considérez l'équation de Burgers sans viscosité
...
\textbf{OPEN-14.} Définissez la théorie de jauge sur réseau de Wilson pour un groupe
...
\textbf{OPEN-15.} Soit $ X $ une variété kählérienne compacte.
\begin{enumerate}
...
\textbf{OPEN-16.} Un entier strictement positif $ n $ est dit \textit{congruent} s'il
...
\textbf{OPEN-46.} Vérifiez à la main que
...
\textbf{OPEN-57.} En 1808, Adrien-Marie Legendre, ajustant une formule à des tables de
...
\textbf{OPEN-58.} Soit C une courbe projective lisse de genre g sur le corps fini
...
\textbf{OPEN-59.} Soit $ \sigma(n) = \sum_{d \mid n} d $ la somme des diviseurs et
...
l'inégalité $ \sigma(n) < e^{\gamma} n \log \log n $ vaut pour tout $ n > 5040 $.
...
\textbf{OPEN-60.} Définissez $ U(n) = n/2 $ pour n pair et
...
\textbf{OPEN-19.} Soit $ T $ l'application de Collatz d'OPEN-17.
\begin{enumerate}
...
\textbf{OPEN-21.} Lisez l'article de Terence Tao de 2019 et comprenez-en précisément
...
\textbf{OPEN-22.} En FRACTRAN, le langage de Conway, un programme est une liste de
...
connu sur cette famille de problèmes, et il reformule la remarque d'Erd\H{o}s : si Collatz
...
\textbf{OPEN-23.} \textbf{Démontrez que tout entier pair supérieur à
...
\textbf{OPEN-24.} La question voisine des écarts \textit{bornés} a été percée : Yitang
...
\textbf{OPEN-25.} Au Congrès international de 1912, Edmund Landau a énuméré quatre
...
\textbf{OPEN-26.} Un nombre est \textit{parfait} s'il est égal à la somme de ses diviseurs
...
\textbf{OPEN-27.} Pour des entiers strictement positifs premiers entre
...
\textbf{OPEN-28.} La constante d'Euler--Mascheroni est
...
\textbf{OPEN-29.} \textbf{Démontrez que toute courbe de Jordan --- toute
...
\textbf{OPEN-30.} Coloriez chaque point du plan de sorte que deux points à distance
...
\textbf{OPEN-31.} Une famille finie d'ensembles est \textit{stable par
...
\textbf{OPEN-32.} $ R(5,5) $ est le plus petit $ n $ tel que tout coloriage en rouge
...
\noindent La célèbre remarque d'Erd\H{o}s dit les choses mieux que n'importe quel
...
\item Lecture : Stanis\l{}aw Radziszowski, \og{} Small Ramsey Numbers \fg{}, panorama dynamique de l'\textit{Electronic Journal of Combinatorics} --- la table de référence des bornes actuelles
...
\textbf{OPEN-33.} Supposons que $ n $ coureurs partent ensemble sur
...
\textbf{OPEN-34.} \textbf{Tout opérateur linéaire borné sur un espace de
...
\textbf{OPEN-35.} Soit $ F : \mathbb{C}^n \to \mathbb{C}^n $ une
...
\textbf{OPEN-36.} Erd\H{o}s et Straus ont conjecturé que, pour tout entier $ n \geq 2 $,
...
\noindent Erd\H{o}s et Ernst Straus ont posé cette question vers 1948. Les fractions
...
rend typique d'Erd\H{o}s, c'est qu'elle est élémentaire à énoncer, trivialement vérifiable sur
...
\item Lecture : Erd\H{o}s Problems (\url{https://www.erdosproblems.com/}) --- le catalogue tenu par Thomas Bloom des problèmes d'Erd\H{o}s et de leur statut
\end{refs}
...
\textbf{OPEN-49.} Pour chaque triplet d'entiers premiers entre eux
...
\textbf{OPEN-50.} Soit $ N(r) $ le nombre de points entiers
...
\textbf{OPEN-51.} Supposons que $ A, B, C, x, y, z $ soient des
...
\textbf{OPEN-52.} Considérez l'équation
\[ a^{m} + b^{n} = c^{k} \]
...
parfaites consécutives --- a résisté de 1844 jusqu'à ce que Preda Mih\u{a}ilescu la démontre en
...
\textbf{OPEN-54.} Pour un entier $ t \geq 2 $, soit $ N(t) $ le nombre de couples
...
Erd\H{o}s et Hanson, 1974) et le raffinement de Kane en 2007
...
théorie des points entiers sur les courbes. En 2021, Matomäki, Radziwi\l{}\l{}, Shao, Tao et
...
\item Article : K. Matomäki, M. Radziwi\l{}\l{}, X. Shao, T. Tao, J. Teräväinen, \og{} Singmaster's conjecture in the interior of Pascal's triangle \fg{}, \textit{Quarterly Journal of Mathematics} 73 (2022), arXiv:2106.03335 (\url{https://arxiv.org/abs/2106.03335})
...
\textbf{OPEN-55.} Tout rationnel $ b/d $ sous forme irréductible admet un
...
\noindent Stanis\l{}aw Zaremba a posé la question au début des années 1970 pour une
...
\textbf{OPEN-56.} Un nombre réel est \textit{normal} en base $ b $ si,
...
\textbf{OPEN-61.} Notons $ g_n = p_{n+1} - p_n $ l'écart qui suit le n-ième nombre
...
La minoration de la question (c) a réglé un problème qu'Erd\H{o}s avait doté de 10 000 dollars,
...
\textbf{OPEN-62.} Le 8 août 1900, au deuxième Congrès international des mathématiciens à
...
\textbf{OPEN-63.} Iouri Matiiassevitch, achevant les travaux de Martin
...
\textbf{OPEN-64.} Démontrez d'abord, en n'utilisant que la
...
attente).} Quelle est la plus grande aire d'une forme rigide que l'on puisse man\oe{}uvrer
...
démontrez que la conjecture de Mertens --- selon laquelle $ |M(x)| < \sqrt{x} $ pour tout
$ x > 1 $ --- aurait impliqué l'hypothèse de Riemann d'OPEN-01. Énoncez ensuite avec soin
